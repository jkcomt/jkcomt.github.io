		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comdemosapui5demosapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemosapui5demosapui5-display": {
								"semanticObject": "comdemosapui5demosapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demosapui5.demosapui5",
									"url": sap.ui.require.toUrl("com/demosapui5/demosapui5")
								}
							}
						}
					}
